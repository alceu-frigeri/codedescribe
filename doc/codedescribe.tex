...
%%
%% This is version {1.23} {2025/12/30}
%%
...
\end{tsremark}
\begin{tsremark}
  If none of these patterns are recognized it will either leave the `!' character or execute its previous code (if it was active).
\end{tsremark}
