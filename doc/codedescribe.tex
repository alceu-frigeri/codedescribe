...
\describe{no index}{This will change all object types default to \tsobj[key,no index]{no index}. This won't suppress index generation, but just change the objects' type default behaviour (see \ref{indexing} and \ref{obj-type-def})}
