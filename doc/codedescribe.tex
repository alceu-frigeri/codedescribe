...
The command \tsobj[code,no index]{\tsobj} and environment \tsobj[env,no index]{codedescribe} create index entries with the command \tsobj[code,no index]{\index} based on the object type (see \ref{obj-type-def}, \ref{desc-env} and \ref{ts-commands}).
